...
console.log('test1', kidsWithCandies(candies, extraCandies));
// apbqcr

candies = [4, 2, 1, 1, 2];
extraCandies = 1;

console.log('test2', kidsWithCandies(candies, extraCandies));
// "apbqrs"

candies = [12, 1, 12];
extraCandies = 10;

console.log('test3', kidsWithCandies(candies, extraCandies));
// "apbqcd"
